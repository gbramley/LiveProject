...
namespace KingslandRedux.Controllers
{
    public class BeveragesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "BeverageID,BeverageName,BeverageCost")] Beverage beverage)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "BeverageID,BeverageName,BeverageCost")] Beverage beverage)
        {
            if (ModelState.IsValid)
            {
